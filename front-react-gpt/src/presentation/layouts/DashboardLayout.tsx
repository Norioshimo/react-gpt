...
import { SidebarManuItem } from "../components";

export const DashboardLayout = () => {
  return (
    <main className="flex flex-row mt-7">
      <nav className="hidden sm:flex flex-col ml-5 w-[370px] min-h-[calc(100vh-3rem)] bg-white/10 p-5 rounded-3xl">
        ...
        {menuRoutes.map((option) => (
          <SidebarManuItem key={option.to} {...option} />
        ))}
      </nav>
